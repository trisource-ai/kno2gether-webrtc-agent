...
async def entrypoint(ctx: JobContext):
        ...
        messages=[
            ChatMessage(
                ...
                content=(
                    ...
                    "You have access to a comprehensive dental knowledge base that you can reference to provide accurate information about dental procedures, conditions, and care. "
    ...
    stream_adapter = tts.StreamAdapter(
        tts=openai_tts,
